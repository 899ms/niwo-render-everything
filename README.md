...
> - 抢先体验最新功能
>
> **[点这里加入用户领航团 →](https://niwo.studio/contact)**
...
<tr>
<td align="center" valign="top">
<video src="https://github.com/user-attachments/assets/a2e4d15b-ff25-4a42-b028-59de57a9c8f2" controls preload="metadata" playsinline width="240"></video>
<p>
瑞士杂志<br>
DeepSeek / 锁36个月
</p>
...
Codex 我们也实测过，可用。WorkBuddy 是配套 Agent，豆包工作模式、Cursor、Claude Code 这类能跑 Skill、带终端的 Agent 同样能装
...
普通聊天装不了、也跑不完这个 Skill。ChatGPT 如果已经在普通聊天里聊过，用 **… → 打开新分支 → 分支到工作模式**
...
| --- | --- | --- |
| 获赠试用积分，可直接用于视频渲染 | 支持邀请码分发，邀请人与被邀请人均可获得积分 | 新成片形态与渲染模型优先开放体验 |
